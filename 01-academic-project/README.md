...
> **Примечание:** Диаграмма имеет большой размер для сохранения детализации. Для удобства просмотра используйте масштабирование браузера или откройте изображение в новой вкладке.
